...
checksum/configMappings: {{ include (print $.Template.BasePath "/local-wiremock/configmap-mappings.yaml") . | sha256sum }}
checksum/configResponses: {{ include (print $.Template.BasePath "/local-wiremock/configmap-responses.yaml") . | sha256sum }}
