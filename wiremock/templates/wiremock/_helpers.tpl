...
{{- default .Chart.Name .Values.wiremock_instance_local.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- if .Values.wiremock_instance_local.fullnameOverride }}
{{- .Values.wiremock_instance_local.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.wiremock_instance_local.nameOverride }}
...
{{- default (include "wiremock.fullname" .) .Values.wiremock_instance_local.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.wiremock_instance_local.serviceAccount.name }}
{{- end }}
{{- end }}
...
{{- if .Values.wiremock_instance_local.podAnnotations }}
{{ .Values.wiremock_instance_local.podAnnotations }}
{{- end }}
{{- end }}
